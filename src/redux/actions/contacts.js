...
// console.log(ContactsApi.createContact( {"name": "Edgars Po"} ) );
// console.log(ContactsApi.createContact( {"name": "Po"} ) );
// setTimeout( () => ContactsApi.getAllContacts().then( (data) => {console.log(data)} ), 3000 );
